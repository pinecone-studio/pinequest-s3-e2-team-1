  ...
  async fetch(request, env) {
    ...
    if (url.pathname === "/generate" && request.method === "POST") {
      ...
      const model = genAI.getGenerativeModel({
        ...
        model: modelOverride ?? env.GEMINI_MODEL ?? "gemini-1.5-flash",
        generationConfig: {
          temperature: 0.1,
...
// .wrangler/tmp/bundle-c0XIz1/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-c0XIz1/middleware-loader.entry.ts
