  ...
  async fetch(request, env) {
    ...
    if (url.pathname === "/generate" && request.method === "POST") {
      ...
      const model = genAI.getGenerativeModel({
        ...
        model: modelOverride ?? env.GEMINI_MODEL ?? "gemini-2.0-flash",
        generationConfig: {
          temperature: 0.1,
...
// .wrangler/tmp/bundle-YckhDr/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-YckhDr/middleware-loader.entry.ts
