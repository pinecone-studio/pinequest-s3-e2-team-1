...
export type FrontendDashboardAttemptFieldsFragment = { __typename?: 'AttemptSummary', attemptId: string, testId: string, title: string, studentId: string, studentName: string, status: string, answerKeySource: string, score?: number | null, maxScore?: number | null, percentage?: number | null, startedAt: string, submittedAt?: string | null, criteria?: { __typename?: 'TestCriteria', gradeLevel: number, className: string, subject: string, topic: string, difficulty: string, questionCount: number } | null, progress: { __typename?: 'ExamProgress', totalQuestions: number, answeredQuestions: number, remainingQuestions: number, completionRate: number }, monitoring?: { __typename?: 'AttemptMonitoringSummary', totalEvents: number, infoCount?: number | null, warningCount: number, dangerCount: number, lastEventAt?: string | null, recentEvents: Array<{ __typename?: 'AttemptMonitoringEvent', id: string, code: string, severity: string, title: string, detail: string, occurredAt: string }> } | null, result?: { __typename?: 'AttemptResultSummary', score: number, maxScore: number, percentage: number, correctCount: number, incorrectCount: number, unansweredCount: number, questionResults: Array<{ __typename?: 'QuestionResult', questionId: string, prompt: string, competency: string, questionType: string, selectedOptionId?: string | null, correctOptionId: string, isCorrect: boolean, pointsAwarded: number, maxPoints: number, explanation?: string | null, dwellMs?: number | null, answerChangeCount?: number | null }> } | null, feedback?: { __typename?: 'AttemptFeedback', headline: string, summary: string, strengths: Array<string>, improvements: Array<string> } | null, teacherSync?: { __typename?: 'TeacherSubmissionSync', status: string, targetService: string, lastError?: string | null, sentAt?: string | null } | null, answerReview?: Array<{ __typename?: 'AttemptAnswerReviewItem', questionId: string, prompt: string, competency: string, questionType: string, selectedOptionId?: string | null, selectedAnswerText?: string | null, points: number, responseGuide?: string | null, dwellMs?: number | null, answerChangeCount?: number | null }> | null };

export type FrontendDashboardLiveFeedFieldsFragment = { __typename?: 'AttemptLiveFeedItem', attemptId: string, testId: string, title: string, studentId: string, studentName: string, status: string, startedAt: string, submittedAt?: string | null, monitoring?: { __typename?: 'AttemptMonitoringSummary', totalEvents: number, infoCount?: number | null, warningCount: number, dangerCount: number, lastEventAt?: string | null } | null, latestEvent?: { __typename?: 'AttemptMonitoringEvent', id: string, code: string, severity: string, title: string, detail: string, occurredAt: string } | null };
...
export type FrontendTakeExamDashboardQuery = { __typename?: 'Query', availableTests: Array<{ __typename?: 'Test', id: string, title: string, description: string, answerKeySource: string, updatedAt: string, criteria: { __typename?: 'TestCriteria', gradeLevel: number, className: string, subject: string, topic: string, difficulty: string, questionCount: number } }>, attempts: Array<{ __typename?: 'AttemptSummary', attemptId: string, testId: string, title: string, studentId: string, studentName: string, status: string, answerKeySource: string, score?: number | null, maxScore?: number | null, percentage?: number | null, startedAt: string, submittedAt?: string | null, criteria?: { __typename?: 'TestCriteria', gradeLevel: number, className: string, subject: string, topic: string, difficulty: string, questionCount: number } | null, progress: { __typename?: 'ExamProgress', totalQuestions: number, answeredQuestions: number, remainingQuestions: number, completionRate: number }, monitoring?: { __typename?: 'AttemptMonitoringSummary', totalEvents: number, infoCount?: number | null, warningCount: number, dangerCount: number, lastEventAt?: string | null, recentEvents: Array<{ __typename?: 'AttemptMonitoringEvent', id: string, code: string, severity: string, title: string, detail: string, occurredAt: string }> } | null, result?: { __typename?: 'AttemptResultSummary', score: number, maxScore: number, percentage: number, correctCount: number, incorrectCount: number, unansweredCount: number, questionResults: Array<{ __typename?: 'QuestionResult', questionId: string, prompt: string, competency: string, questionType: string, selectedOptionId?: string | null, correctOptionId: string, isCorrect: boolean, pointsAwarded: number, maxPoints: number, explanation?: string | null, dwellMs?: number | null, answerChangeCount?: number | null }> } | null, feedback?: { __typename?: 'AttemptFeedback', headline: string, summary: string, strengths: Array<string>, improvements: Array<string> } | null, teacherSync?: { __typename?: 'TeacherSubmissionSync', status: string, targetService: string, lastError?: string | null, sentAt?: string | null } | null, answerReview?: Array<{ __typename?: 'AttemptAnswerReviewItem', questionId: string, prompt: string, competency: string, questionType: string, selectedOptionId?: string | null, selectedAnswerText?: string | null, points: number, responseGuide?: string | null, dwellMs?: number | null, answerChangeCount?: number | null }> | null }>, liveMonitoringFeed: Array<{ __typename?: 'AttemptLiveFeedItem', attemptId: string, testId: string, title: string, studentId: string, studentName: string, status: string, startedAt: string, submittedAt?: string | null, monitoring?: { __typename?: 'AttemptMonitoringSummary', totalEvents: number, infoCount?: number | null, warningCount: number, dangerCount: number, lastEventAt?: string | null } | null, latestEvent?: { __typename?: 'AttemptMonitoringEvent', id: string, code: string, severity: string, title: string, detail: string, occurredAt: string } | null }> };
