...
export type AttemptMonitoringEventFieldsFragment = { __typename?: 'AttemptMonitoringEvent', id: string, code: string, severity: string, title: string, detail: string, occurredAt: string, mode: string, screenshotCapturedAt?: string | null, screenshotStorageKey?: string | null, screenshotUrl?: string | null };

export type AttemptMonitoringSummaryFieldsFragment = { __typename?: 'AttemptMonitoringSummary', totalEvents: number, warningCount: number, dangerCount: number, lastEventAt?: string | null, recentEvents: Array<{ __typename?: 'AttemptMonitoringEvent', id: string, code: string, severity: string, title: string, detail: string, occurredAt: string, mode: string, screenshotCapturedAt?: string | null, screenshotStorageKey?: string | null, screenshotUrl?: string | null }> };
