...
const QUESTION_BANK: Record<string, StudentExamQuestion[]> = {
	...
	"test-math-functions": [
		...
		},
		{
			questionId: "q-math-3",
			type: "math",
			prompt: "x^2+x-2=0 тэгшитгэлийг бод.",
			points: 2,
			options: [],
			responseGuide: "x=1, -2",
		},
...
let attemptsStore: AttemptSummary[] = [
	{
		...
		result: {
			...
			questionResults: [
				...
				},
				{
					...
					pointsAwarded: 1,
					maxPoints: 1,
					explanation: "Зөв тодорхойлсон байна.",
				},
				{
					questionId: "q-math-3",
					prompt: "x^2+x-2=0 тэгшитгэлийг бод.",
					competency: "Тэгшитгэл",
					questionType: "math",
					selectedOptionId: "x=1",
					correctOptionId: "",
					isCorrect: false,
					pointsAwarded: 1,
					maxPoints: 2,
					explanation: "Нэг язгуурыг зөв олсон ч нөгөө язгуур болох x=-2-ыг дутуу бичсэн байна.",
		...
		answerReview: [
			...
			},
			{
				...
				questionType: "single-choice",
				selectedOptionId: "a",
				selectedAnswerText: "Тэгш",
				correctAnswerText: "Тэгш",
				points: 1,
			},
			{
				questionId: "q-math-3",
				...
				questionType: "math",
				selectedOptionId: "x=1",
				selectedAnswerText: "x=1",
				correctAnswerText: "x=1, -2",
				points: 2,
				responseGuide: "Тэгшитгэлийг (x+2)(x-1)=0 гэж задалж, x=1, -2 гэж олно.",
			},
		],
	},
	{
